...
@Order(50)
public class ESQueryTest extends ApplicationTests {
    @Resource
    ...
    public void matchQuery() throws IOException {
        List<Spu> result = queryApi.matchQuery(indexName, "android手机", "productName", "id", 0, 1, true, Spu.class);
    ...
    public void multiMatchQuery() throws IOException {
        ...
        List<Spu> result = queryApi.multiMatchQuery(indexName, "人民共和", fields, "id", 0, 1, true, Spu.class);
        result.forEach(spu -> log.info(String.valueOf(spu)));
    ...
    public void termQuery() throws IOException {
        List<Spu> result = queryApi.termQuery(indexName, "android", "productName", "id", 0, 1, true, Spu.class);
        result.forEach(spu -> log.info(String.valueOf(spu)));
        ...
        result = queryApi.termQuery(indexName, "android手机", "productName", "id", 0, 1, true, Spu.class);
        result.forEach(spu -> log.info(String.valueOf(spu)));
    ...
    public void fuzzyQuery() throws IOException {
        List<Spu> result = queryApi.fuzzyQuery(indexName, "李", "brandName", "id", 0, 1, true, Spu.class);
        result.forEach(spu -> log.info(String.valueOf(spu)));
    ...
    public void matchPhrasePrefixQuery() throws IOException {
        List<Spu> result =
                queryApi.matchPhrasePrefixQuery(indexName, "人民共", "productName", "id", 0, 1, true, Spu.class);
        result.forEach(spu -> log.info(String.valueOf(spu)));
        ...
        result = queryApi.matchPhrasePrefixQuery(indexName, "鼠", "brandName", "id", 0, 1, true, Spu.class);
        result.forEach(spu -> log.info(String.valueOf(spu)));
    ...
    public void rangeQuery() throws IOException {
        List<Spu> result =
                queryApi.rangeQuery(indexName, "android", "服装", "productName", "id", 0, 3, false, Spu.class);
        result.forEach(spu -> log.info(String.valueOf(spu)));
    ...
    public void wildcardQuery() throws IOException {
        ...
        List<Spu> result = queryApi.wildcardQuery(indexName, "*", "productName", "id", 0, 3, false, Spu.class);
        result.forEach(spu -> log.info(String.valueOf(spu)));
    ...
    public void constantScoreQuery() throws IOException {
        List<Spu> result =
                queryApi.constantScoreQuery(indexName, "android", "productName", 0.2f, "id", 0, 3, false, Spu.class);
        result.forEach(spu -> log.info(String.valueOf(spu)));
    ...
    public void disMaxQuery() throws IOException {
        ...
        Query qb1 = Query.of(q -> q.term(t -> t.field("productName").value("android")));
        Query qb2 = Query.of(q -> q.term(t -> t.field("brandName").value("李宁")));

        queries.add(qb1);
        queries.add(qb2);

        List<Spu> result = queryApi.disMaxQuery(indexName, queries, 1.3f, 0.7d, "id", 0, 3, false, Spu.class);
        result.forEach(spu -> log.info(String.valueOf(spu)));
    ...
    public void queryStringQuery() throws IOException {
        List<Spu> result = queryApi.queryStringQuery(indexName, "+android", "id", 0, 3, false, Spu.class);
        result.forEach(spu -> log.info(String.valueOf(spu)));
    ...
    public void spanFirstQuery() throws IOException {
        List<Spu> result =
                queryApi.spanFirstQuery(indexName, "android", "productName", 30000, "id", 0, 3, false, Spu.class);
        result.forEach(spu -> log.info(String.valueOf(spu)));
    ...
    public void spanTermQuery() throws IOException {
        List<Spu> result = queryApi.spanTermQuery(indexName, "android", "productName", "id", 0, 3, false, Spu.class);
        result.forEach(spu -> log.info(String.valueOf(spu)));
